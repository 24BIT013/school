  ...
  return (
    <div className="auth-wrap">
      <div className="card auth-card">
        ...
        <p className="muted">Register as a student to access courses, registrations, and results.</p>
        ...
        <p className="muted auth-foot">
          Already have an account? <Link to="/login">Login</Link> | <Link to="/admin/register">Register as Admin</Link>
        </p>
      </div>
    </div>
  );
